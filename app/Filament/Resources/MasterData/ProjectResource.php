...
use App\Filament\Resources\MasterData\ProjectResource\Pages;
...
class ProjectResource extends BaseResource
{
    ...
    protected static ?string $translationKey = 'project';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('project_type')->label(__('fields.project_type'))->options(ProjectType::class)->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                static::nameColumn(),
                TextColumn::make('project_type')->label(__('fields.project_type'))->badge(),
