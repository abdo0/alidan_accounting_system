...
use App\Filament\Resources\MasterData\CostCenterResource\Pages;
...
/** @extends BaseResource<CostCenter> */
class CostCenterResource extends BaseResource
{
    ...
    protected static ?string $translationKey = 'cost_center';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('cc_type')->label(__('fields.cc_type'))->options(CostCenterType::class)->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                static::nameColumn(),
                TextColumn::make('cc_type')->label(__('fields.cc_type'))->badge(),
